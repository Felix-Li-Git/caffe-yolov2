...
def detect(net, img_filename, mode):
    ...
    img2 = show_results(img_cv, results)
    t_end = datetime.now()
...
def main():
    ...
    parser.add_argument('video', type=str, help='input video', default='a')
    ...
    print('video file is {}'.format(args.video))
