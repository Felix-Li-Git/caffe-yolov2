...
def detect(model_filename, weight_filename, img_filename, mode):
    ...
    results = get_candidate_objects(out['conv23'][0], img.shape, mode)
...
"""
model_file = '/home/serge30/Escritorio/YOLOv2/prototxt/yolo.prototxt'
param_file = '/home/serge30/Escritorio/YOLOv2/caffemodel/yolo.caffemodel'


#Detection for just a single image
#Uncomment the following two lines and show_results in detect if you just want to test a single image.
img_file = '/home/serge30/Escritorio/YOLOv2/images/oil/1026.jpg'
detect(model_file, param_file, img_file, 'coco')
